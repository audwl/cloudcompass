...
const awsSources: Record<string, { docs: string; pricing: string; label: string }> = {
  EC2: { label: "Amazon EC2", docs: "https://docs.aws.amazon.com/ec2/latest/instancetypes/instance-types.html", pricing: "https://aws.amazon.com/ec2/pricing/on-demand/" },
  "ECS on Fargate": { label: "AWS Fargate", docs: "https://docs.aws.amazon.com/AmazonECS/latest/developerguide/AWS_Fargate.html", pricing: "https://aws.amazon.com/fargate/pricing/" },
  EKS: { label: "Amazon EKS", docs: "https://docs.aws.amazon.com/eks/latest/userguide/what-is-eks.html", pricing: "https://aws.amazon.com/eks/pricing/" },
  Lambda: { label: "AWS Lambda", docs: "https://docs.aws.amazon.com/lambda/latest/dg/welcome.html", pricing: "https://aws.amazon.com/lambda/pricing/" },
  "Aurora PostgreSQL": { label: "Amazon Aurora", docs: "https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/CHAP_AuroraOverview.html", pricing: "https://aws.amazon.com/rds/aurora/pricing/" },
  "RDS PostgreSQL": { label: "Amazon RDS", docs: "https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.DBInstanceClass.html", pricing: "https://aws.amazon.com/rds/postgresql/pricing/" },
  "RDS MySQL": { label: "Amazon RDS", docs: "https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/CHAP_MySQL.html", pricing: "https://aws.amazon.com/rds/mysql/pricing/" },
  "Aurora Serverless v2": { label: "Aurora Serverless v2", docs: "https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/aurora-serverless-v2.html", pricing: "https://aws.amazon.com/rds/aurora/pricing/" },
  "OpenSearch Managed": { label: "Amazon OpenSearch Service", docs: "https://docs.aws.amazon.com/opensearch-service/latest/developerguide/what-is.html", pricing: "https://aws.amazon.com/opensearch-service/pricing/" },
  "OpenSearch Serverless": { label: "OpenSearch Serverless", docs: "https://docs.aws.amazon.com/opensearch-service/latest/developerguide/serverless.html", pricing: "https://aws.amazon.com/opensearch-service/pricing/" },
  "OpenSearch on EC2": { label: "OpenSearch on EC2", docs: "https://docs.aws.amazon.com/ec2/latest/instancetypes/instance-types.html", pricing: "https://aws.amazon.com/ec2/pricing/on-demand/" },
  "ElastiCache Valkey": { label: "Amazon ElastiCache", docs: "https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/WhatIs.html", pricing: "https://aws.amazon.com/elasticache/pricing/" },
  "ElastiCache Redis OSS": { label: "Amazon ElastiCache", docs: "https://docs.aws.amazon.com/AmazonElastiCache/latest/dg/WhatIs.html", pricing: "https://aws.amazon.com/elasticache/pricing/" },
  MemoryDB: { label: "Amazon MemoryDB", docs: "https://docs.aws.amazon.com/memorydb/latest/devguide/what-is-memorydb-for-redis.html", pricing: "https://aws.amazon.com/memorydb/pricing/" },
};
...
export default function Dashboard() {
  ...
  const sources = awsSources[product] ?? awsSources.EC2;
  ...
  return <main>
    <nav className="nav shell"><button className="brand" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}><span className="brandMark">C</span><span>CloudCompass</span></button><div className="navLinks"><a href={`/info/about?lang=${locale}`}>{locale === "ko" ? "소개" : "About"}</a><a href={`/info/guides?lang=${locale}`}>{locale === "ko" ? "가이드" : "Guides"}</a><details className="resourceMenu"><summary>{locale === "ko" ? "법률·도움말" : "Legal & help"} ▾</summary><div><a href={`/info/privacy?lang=${locale}`}>{locale === "ko" ? "개인정보처리방침" : "Privacy policy"}</a><a href={`/info/terms?lang=${locale}`}>{locale === "ko" ? "이용약관" : "Terms of use"}</a><a href={`/info/disclaimer?lang=${locale}`}>{locale === "ko" ? "면책 고지" : "Disclaimer"}</a><a href={`/info/contact?lang=${locale}`}>{locale === "ko" ? "문의" : "Contact"}</a></div></details></div><div className="navActions"><button className="language" onClick={() => setLocale(locale === "en" ? "ko" : "en")}>◎ {locale.toUpperCase()}</button><a className="navCta" href="#journey">{t.start} <span>→</span></a></div></nav>
