...
export default function Dashboard() {
  ...
  return <main>
    <nav className="nav shell"><button className="brand" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}><span className="brandMark">C</span><span>CloudCompass</span></button><div className="navLinks"><a href="/info/about">About</a><a href="/info/guides">Guides</a><details className="resourceMenu"><summary>Legal & help ▾</summary><div><a href="/info/privacy">Privacy policy</a><a href="/info/terms">Terms of use</a><a href="/info/disclaimer">Disclaimer</a><a href="/info/contact">Contact</a></div></details></div><div className="navActions"><button className="language" onClick={() => setLocale(locale === "en" ? "ko" : "en")}>◎ {locale.toUpperCase()}</button><a className="navCta" href="#journey">{t.start} <span>→</span></a></div></nav>
    ...
    <footer><div className="shell"><span className="brand"><span className="brandMark">C</span><span>CloudCompass</span></span><p><a href="/info/about">About</a> · <a href="/info/guides">Guides</a> · <a href="/info/privacy">Privacy</a> · <a href="/info/terms">Terms</a> · <a href="/info/contact">Contact</a></p></div></footer>
  </main>;
}
