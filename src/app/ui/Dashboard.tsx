...
export default function Dashboard() {
  ...
  const options = useMemo(() => {
    ...
    const preferred = { cost: 0, balanced: 1, performance: 2, reliability: 2 }[focus];
    return catalog[service].map((item, index) => ({ ...item, price: item.base * factor, score: index === preferred ? 96 : index === 1 ? 88 : 81 }));
  }, [service, traffic, focus]);
